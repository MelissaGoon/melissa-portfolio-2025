...
const Header = () => {
    ...
    return (
        <header className={styles.header}>
            <nav >
                <NavLink to='/' className={styles.logo_link} aria-label="Melissa Goon's Logo - Home">

                    <svg focusable="false" aria-hidden="true" width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
