...
const Footer = () => {
    ...
    return (
        <footer id="contact" className={styles.footer_wrapper}>
            <div className={styles.footer}>
                ...
                <div className={styles.social_links}>
                    ...
                    <a href="https://www.linkedin.com/in/melissagoon" target="_blank" rel="noopener noreferrer">
                        ...
                        <svg focusable="false" aria-hidden="true" width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
